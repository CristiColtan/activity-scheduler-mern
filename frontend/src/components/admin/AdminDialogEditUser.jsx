...
const AdminDialogEditUser = ({ open, setOpen, userData, allUsers, setAllUsers }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:8081/backend/admin/edit/user-fetch-users/${userData._id}`, {
        method: "PUT",
        headers: {
        ...
        <div className='mt-2 flex flex-col gap-6'>
          <div className='flex flex-row gap-5'>
            <div className='w-full flex flex-col gap-1'>
              <label htmlFor='first_name' className='font-normal text-base'>First Name:</label>
            ...
            <div className='w-full flex flex-col gap-1'>
              <label htmlFor='last_name' className='font-normal text-base'>Last Name:</label>
          ...
          <div className='flex flex-row gap-5'>
            <div className='w-full flex flex-col gap-1'>
              <label htmlFor='username' className='font-normal text-base'>Username:</label>
            ...
            <div className='w-full flex flex-col gap-1'>
              <label htmlFor='email' className='font-normal text-base'>E-mail:</label>
          ...
          <div className='flex flex-row gap-5'>
            <div className='w-full flex flex-col gap-1'>
              <label htmlFor='city' className='font-normal text-base'>City:</label>
            ...
            <div className='w-full flex flex-col gap-1'>
              <label htmlFor='gender' className='font-normal text-base'>Gender:</label>
