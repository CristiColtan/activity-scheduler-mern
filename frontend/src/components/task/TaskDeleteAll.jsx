...
const TaskDeleteAll = ({ open, setOpen, trashedTasks, setTrashedTasks }) => {
  ...
  console.log("tasks delete all:", trashedTasks);
  ...
  const deleteAllTasks = async () => {
    try {
      ...
      const res = await fetch(`http://localhost:8081/backend/task/delete-all-tasks`, {
        method: "DELETE",
        headers: {
      ...
      <MyModal open={open} setOpen={setOpen}>
        <div className='py-4 w-full flex flex-col gap-4 items-center justify-center'>
          ...
          <div className='py-3 flex justify-between gap-4 bg-white w-auto'>
            ...
            hover:bg-red-400' onClick={deleteAllTasks}>
