...
const AddTeamManager = ({ open, setOpen }) => {
    ...
    const fetchNormalUsers = async () => {
        try {
            ...
            if (currentUser.is_admin === "Yes") {
                res = await fetch("http://localhost:8081/backend/admin/get/normal-users", {
                    credentials: "include",
                });
            }
    ...
    const handleAddTeamManager = async () => {
        try {
            ...
            const res = await fetch("http://localhost:8081/backend/admin/add/team-manager", {
                method: "POST",
                headers: {
    ...
    return (
        <>
            <MyModal open={open} setOpen={setOpen}>
                ...
                <TaskAddUserList team={teamManagers} setTeam={setTeamManagers} data={normalUsers}></TaskAddUserList>
                {
