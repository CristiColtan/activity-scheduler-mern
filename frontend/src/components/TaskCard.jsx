    ...
    <>
      <div className="w-full h-fit bg-white shadow-lg rounded p-4">
        <div className="w-full flex justify-between">
          <div
            className={clsx(
              "flex flex-1 gap-1.5 items-center font-medium -ml-0.5",
        ...
        <>
          <div className="flex items-center gap-2">
            ...
            />
            <h4 className="text-black line-clamp-1 font-serif">
              {task?.title}
            </h4>
          </div>
          <div className="flex">
            ...
            <div className="flex items-center gap-3 mt-1">
              <div className="flex gap-1 items-center font-thin text-black">
                ...
                <span className="font-thin">
                  {Activitiess && Array.isArray(Activitiess)
                    ? Activitiess.length
                    : 0}
                </span>
              </div>
