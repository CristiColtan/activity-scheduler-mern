...
const MyModal = ({ open, setOpen, children, onCancel }) => {
      ...
      >
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            >
              <DialogPanel
                className="w-full relative transform overflow-hidden rounded-lg bg-[#f2f2f2] text-left shadow-xl
                          transition-all pb-0 sm:my-8 sm:w-full sm:max-w-lg"
              >
