          ...
          <table className="w-full mb-5">
            ...
            <tbody className="">
              {tasks && tasks.length > 0 ? (
                tasks.map((task, id) => <MyTableRow key={id} task={task} />)
              ) : (
                <>
                  <tr>
          ...
          <td className="py-2">
            <p
              className={clsx(
                ...
                user?.is_active === "Yes" ? "bg-blue-200" : "bg-yellow-200"
              )}
            >
                  ...
                  <tr>
                    <td colSpan="5" className="text-center py-4 text-lg">
                      ...
                      currentUser.is_admin === "No"
                        ? "You have no special rights to see other users!"
                        : "No users available."}
                    </td>
                  </tr>
                </>
  ...
  const MyDashCard = ({ icon, bg, label, count, lastmonth }) => {
    return (
      <div className="w-full h-32 bg-white shadow-md p-5 rounded-md flex items-center justify-between">
        ...
        <div
          className={clsx(
            "text-xl w-10 flex h-10 rounded-full items-center justify-center text-white",
            bg
          )}
        >
          {icon}
