...
import DialogSetUp2Fa from "../components/dialog/DialogSetUp2Fa.jsx";
import DialogDisable2Fa from "../components/dialog/DialogDisable2Fa.jsx";
          ...
          <>
            {errorProfile ? (
              <p className="text-red-500 text-4xl">
                Something went wrong! {errorProfile}
              </p>
            ) : (
              <>
                ...
                <TabsProfile tabs={tabs} setSelected={setSelected}>
                  ...
                  {selected === 0 && (
                    <>
                      ...
                      <p className="font-thin border-b-2 mb-4">
                      ...
                      <div className="flex items-center justify-center border-t-2 flex-col mr-2">
                        ...
                        <div className="w-full grid grid-cols-3 gap-5 2xl:gap-8 overflow-y-auto border-t-2 mt-2">
                          ...
                          <div className="space-y-6 p-4 bg-white shadow-lg text-center">
                            <button
                              className={clsx(
                                "text-blue-700 hover:text-blue-400 inline-flex items-center disabled:cursor-not-allowed disabled:text-blue-500 border-gray-500 translate-y-1",
                                {
                                  "text-blue-400 shadow-xl border border-gray-200 rounded":
                        ...
                        <div className="w-full grid grid-cols-3 gap-5 2xl:gap-8 overflow-y-auto border-t-2 mt-2">
                          ...
                          <div className="space-y-6 p-4 bg-white shadow-lg  text-center">
                            <button
                              className={clsx(
                                "text-blue-700 hover:text-blue-400 inline-flex items-center disabled:cursor-not-allowed disabled:text-blue-400 border-gray-500 translate-y-1",
                                {
                                  "text-blue-400 shadow-xl border border-gray-200 rounded":
                        ...
                        <div className="w-full grid grid-cols-3 gap-5 2xl:gap-8 overflow-y-auto  mt-2">
                          {/* left */}
                          <div className="space-y-6 p-4 text-center"></div>
                          ...
                          <div className="space-y-6 p-4 bg-white text-center">
                            <button
                              className="bg-blue-600 hover:bg-blue-400 inline-flex items-center disabled:cursor-not-allowed 
                    ...
                    <>
                      ...
                      <div className="flex items-center justify-center border-t-2 flex-col mr-2">
                        <div className="w-full grid grid-cols-3 gap-5 2xl:gap-8 overflow-y-auto mt-2">
                          ...
                          <div className="space-y-6 p-4 bg-white shadow-lg flex items-center justify-center text-center">
                            <button
                              className="text-blue-700 hover:text-blue-400 inline-flex 
                    ...
                    <>
                      ...
                      <div className="flex items-center justify-center border-t-2 flex-col mr-2">
                        ...
                        <div className="w-full grid grid-cols-3 gap-5 2xl:gap-8 overflow-y-auto mt-2">
                          ...
                          <div className="space-y-6 p-4 bg-white shadow-lg text-center">
                            <span className="font-serif md:text-base text-sm">
                              Disable your two-factor authentication. You will
                              be able to set it up again. This will not delete
                              your account.
                            </span>
                          </div>
                    ...
                    <>
                      ...
                      <div className="flex items-center justify-center border-t-2 flex-col mr-2">
                        <div className="w-full grid grid-cols-3 gap-5 2xl:gap-8 overflow-y-auto mt-2">
                          ...
                          <div className="space-y-6 p-4 bg-white shadow-lg flex items-center justify-center text-center">
                            <span className="font-serif md:text-base text-sm">
                              Select "Manage" to change your privacy settings
                              and exercise your rights using our request form.
                            </span>
                          </div>
                  ...
                  {selected === 4 && (
                    <>
                      ...
                      <p className="font-thin border-b-2 mb-4">
                        Decide what you want to be notified about, and
                      ...
                      <div className="flex items-center justify-center border-t-2 flex-col mr-2">
                        <div className="w-full grid grid-cols-3 gap-5 2xl:gap-8 overflow-y-auto mt-2">
                          ...
                          <div className="space-y-6 p-4 bg-white shadow-lg flex items-center justify-center text-center">
                            <span className="font-serif md:text-base text-sm">
                              This is the email address we send you
                              notifications.
                            </span>
                          </div>
